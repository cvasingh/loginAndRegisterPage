...
import xyzimg from './img/style/xyz.png';
      ...
      <div>
        <div className='course-section mb-5'>
          <div className='row align-items-center justify-content-center mx-0'>
            <div className='col-md-4 col-sm-10 order-md-5 course-box'>
              {/* <img className='course-box-img' src={xyzimg} /> */}
              <img className='course-box-thumbnail' src={props.data.img} />
            </div>
            <div className='col-md-8 col-sm-10  order-md-1'>
              <div className=" mx-5 my-3 p-4">
                <h1 className='text-ska-primary'>{props.data.name}</h1>
                <p>{props.data.desc}</p>
                <h4>Price: ₹.{props.data.price}</h4>
                <div class="btn btn-ska-primary-dark">Enroll Now</div>
              </div>
            </div>
          </div>
        </div>
